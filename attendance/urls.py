...
urlpatterns = [
    ...
    path('attendance/', views.attendance_submission_class, name='attendance_submission_cls'),
    ...
    path('submit/<int:class_id>/', views.attendance_submission, name='attendance_submission'),
    ]
